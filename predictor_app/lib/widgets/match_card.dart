  ...
  Widget _stackingExample() => Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const Text('One score right (home = 2 ✓, away wrong, wrong result) → +10 pts',
          style: TextStyle(fontSize: 11, color: Color(0xFFF59E0B), height: 1.4)),
        const SizedBox(height: 8),
